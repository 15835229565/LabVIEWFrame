...
<Library LVVersion="18008000">
	...
	<Item Name="操作者消息" Type="Folder">
		<Item Name="UIErrorHandler消息.lvclass" Type="LVClass" URL="../ErrorHanlder Messages/UIErrorHandler消息/UIErrorHandler消息.lvclass"/>
	</Item>
	<Item Name="调用者抽象消息" Type="Folder"/>
	<Item Name="ErrorHanlder.lvclass" Type="LVClass" URL="../ErrorHanlder/ErrorHanlder.lvclass"/>
</Library>
